...
describe('AdapterLoader', () => {
    ...
    describe('error handling', () => {
        it('AdapterNotFoundError has packageName in message', () => {
            const error = new AdapterNotFoundError('@cdps/missing-adapter', 'Cannot find module');
        ...
        it('AdapterLoadError has packageName and reason', () => {
            const error = new AdapterLoadError('@cdps/bad-adapter', 'Missing default export');
        ...
        it('AdapterInitError has packageName and reason', () => {
            const error = new AdapterInitError('@cdps/adapter', 'Invalid credentials');
        ...
        it('AdapterUsageError has dimension parameter', () => {
            const error = new AdapterUsageError('@cdps/adapter', '5h', 'API timeout');
            expect(error.packageName).toBe('@cdps/adapter');
