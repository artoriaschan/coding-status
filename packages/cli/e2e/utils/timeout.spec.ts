...
import { withTimeout, TimeoutError, STATUSLINE_TIMEOUT_MS } from '../../src/utils/timeout.js';
...
describe('withTimeout', () => {
    ...
    it('should preserve original promise rejection', async () => {
        ...
        await expect(withTimeout(errorPromise, 100, 'test-operation')).rejects.toThrow(
            'original error'
        );
    });
});
